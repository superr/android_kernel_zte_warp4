...
//	unsigned int initial_count, final_count;
	unsigned int initial_count;//ZTE_PM_LHX enable 0.5s wakelock for all
...
#if 0 	//ZTE_PM_LHX enable 0.5s wakelock for all
...
#endif
	pr_info("ZTE_PM hold wakelock 0.5s \n "); //ZTE_PM_LHX enable 0.5s wakelock for all
